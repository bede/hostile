...
def test_minimal_fastqs():
    lib.dehost_fastqs(
        fastq1=data_dir / "h37rv_10.r1.fastq.gz",
        fastq2=data_dir / "h37rv_10.r1.fastq.gz",
        index=Path("tests/data/MN908947/MN908947"),
...
def test_minimal_fastqs_cli():
    run(
        f"hostile --fastq1 h37rv_10.r1.fastq.gz --fastq2 h37rv_10.r2.fastq.gz --index MN908947/MN908947 --out-dir test_minimal_fastqs"
    )
